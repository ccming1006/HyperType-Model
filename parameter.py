...
def plot_lst(key,s_range,mode):
    ...
    for x in s_range:
        ...
        if(mode=='a'):
            ...
            triangle_num=sum(triangle_lst.values())
            triplets=1
            gcc=triangle_num/triplets
            lst.append(gcc)
    return lst
...
#AlBe([0.95,[0.1,0.2,0.3,0.4]],[0.7,[0.1,0.2,0.3,0.4]],[0.95,[0.25,0.25,0.25,0.25]],[0.7,[0.25,0.25,0.25,0.25]],'a')
########################Legend: Key Prob END####################################
